-- Base quotation_requests table, RLS, and quotation-pdfs storage (required for admin review in all environments).
-- Depends on auth_roles_setup.sql (public.is_admin()).
...
-- Private bucket for generated quotation PDFs.
