...
const SiteHeader = ({ onMenuClick }: Props) => {
  ...
  const profileHref = useMemo(() => {
    ...
    // If there's an auth session but the user isn't in the "approved employer tools" state,
    // sending them to /login would immediately bounce to "/" due to Login.tsx session guard.
