...
export function PaymentReceiptSubmissionReviewPanel({
  submission,
  employerLabel,
  readOnly,
  isSaving,
  ...
  return (
    <section className="sk-card p-6">
      <h2 className="text-xl font-bold text-primary">
        {readOnly ? "Payment receipt" : "Review payment receipt"}
      </h2>

      <p className="mt-3 text-sm text-ink-muted">
        {readOnly
          ? "View the submitted payment receipt below."
          : "Check the receipt below matches the course and proposed date, and that the payment details look correct before approving."}
      </p>
      ...
      <div className="mt-6">
        ...
        <SubmissionFilePreview
          storagePath={submission.file_storage_path}
        ...
        <>
          <label className="mt-6 block">
            ...
            <textarea
              ...
              placeholder="Explain what is wrong with the receipt…"
              disabled={isSaving}
            />
          </label>
          ...
          <div className="mt-4 flex flex-wrap gap-2">
            <button
              ...
              onClick={onApprove}
            >
              {isSaving ? "Saving…" : "Approve receipt"}
            </button>
            <button
              type="button"
